...
class LogicSelectSkinCommand(LogicCommand):
    ...
    def decode(self, calling_instance):
        ...
        fields["TargetSkin"] = calling_instance.readDataReference()
        LogicCommand.parseFields(fields)
        return fields

    def execute(self, calling_instance, fields, cryptoInit):
        SelectedBrawler = Skins.getBrawlerBySkin(fields["TargetSkin"][1])
        calling_instance.player.SelectedSkins[SelectedBrawler] = fields["TargetSkin"][1]
